                                    ...
                                    <form wire:submit.prevent="store">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" wire:model="email" class="form-control"
                                                placeholder="Email" wire:blur="validateOnBlur('email')" required>
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" wire:model="phone" class="form-control"
                                                placeholder="Phone" wire:blur="validateOnBlur('phone')" required>
                                            @error('Phone')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="password" wire:model="password" class="form-control"
                                                placeholder="Phone" wire:blur="validateOnBlur('password')" required>
                                            @error('Password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select wire:model="role_id" class="form-control"
                                                wire:blur="validateOnBlur('role_id')" required>
                            ...
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($models as $model)
                                        ...
                                        @elseif ($editFormModel == $model->id)
                                            <tr>
                                                <th>{{ $model->id }}</th>
                                                <td>
                                                    <input type="text" wire:model.defer="editName"
                                                        wire:keydown.enter="updateUser" class="form-control"
                                                        placeholder="Name" required>
                                                </td>
                                                <td>
                                                    <select wire:model.defer="editRole_id"
                                                        wire:keydown.enter="updateUser" class="form-control">
                                                        @foreach ($roles as $role)
                                                ...
                                                <td>
                                                    <input type="number" wire:model.defer="editPhone"
                                                        wire:keydown.enter="updateUser" class="form-control"
                                                        placeholder="Phone" required>
                                                </td>
                                                <td>
                                                    <input type="password" wire:model.defer="editPassword"
                                                        wire:keydown.enter="updateUser" class="form-control"
